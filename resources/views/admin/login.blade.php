...
>
  <head>
    ...
    <title>Login Boutique Mina</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('admin_asset/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder ">Administrative Panel</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2" >Welcome to Boutik Mina! 👋</h4>
