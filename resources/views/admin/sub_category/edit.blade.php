                            ...
                            <div class="mb-3">
                                ...
                                <select name="category" id="category" class="form-control">
                                    ...
                                    @foreach ($categories as $category)
                                       <option {{ ($subCategory->category_id == $category->id) ? 'select' : '' }}
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="showHome" id="showHome" class="form-control">
                                    <option {{ ($subCategory->showHome == 'Yes') ? 'select' : '' }} value="Yes">Yes</option>
                                    <option {{ ($subCategory->showHome == 'No') ? 'select' : '' }} value="No">No</option>
                                </select>
                            </div>
                        </div>
                    </div>
