                               ...
                               <div class="col-md-3" id="image-row-{{ $image->id }}">
                                    <div class="card">
                                       <input type="hidden" name="image_array[]" value="{{ $image->id }}">
                                         <img src="{{ asset('temp/'.$image->image) }}" class="card-img-top" alt="">
                                      <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <input class="custom-control-input" type="checkbox" id="track_qty" name="track_qty" value="Yes" checked {{ $product->track_qty == 'Yes' ? 'cheked' : ''}} >
...
const dropzone = new Dropzone('#image', {
    ...
    success: function(file, response) {
        // console.log(response.image_id);  // Ajouter console.log pour vérifier les valeurs
